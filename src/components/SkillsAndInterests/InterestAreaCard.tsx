...
function InterestAreaCard({
  ...
  return (
    <div
      className={`w-mobile rounded-lg border border-slate-500/50 bg-slate-500/50 p-4 font-main shadow-md backdrop-blur-sm 
      transition duration-300 hover:-translate-y-2 hover:cursor-pointer hover:shadow-xl hover:shadow-sky-200/10 sm:h-72 sm:max-w-md sm:hover:-skew-y-1 
